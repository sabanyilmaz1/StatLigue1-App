...
import JoueurEquipeItem from './joueurEquipeItem'

interface JoueurEquipeListProps extends NavigationProps {
  joueurs: Array<Joueur>
}

export default class JoueursList extends Component<JoueurEquipeListProps> {
  render() {
